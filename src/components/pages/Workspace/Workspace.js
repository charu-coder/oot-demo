...
import { getAllWorkspaces, isTokenExpired, login, workspacesDummy } from "../../../utils";
...
export default function Workspace(props) {
  ...
  useEffect(()=>{
   ...
   console.log("all data out", ans)
    ...
    console.log("all workspaces out", workspaces, rows, selected)
    useEffect (()=> {
      
      console.log("all selected workspaces", [selected])
    },[selected])

    // props.handleSelectedWorkspace(rows[selected]?.datasetId)
  ...
  const handleClick = (event, id) => {
    ...
    const selectedItems = rows[id]?.datasetId;
      sessionStorage.setItem("selectedWorkspaces",selectedItems)
      props.handleSelectedWorkspace(rows[id]?.datasetId,id)
      console.log("all selected workspaces", [selectedItems])
    // props.handleSelectedWorkspace(id)
  };
