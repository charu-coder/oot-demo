...
const SideMenu = (props) => {
  ...
  console.log("selectde workspace", selectedWorkspces)
  useEffect(() => {
    let ans = getAllReports(props.workspaceId).then((data) => {
          console.log("report data", data.value);
  ...
  // console.log("all data from state", allReportsData);
  ...
  console.log("is hecked", isChecked);
  useEffect(() => {
    if (inactive) {
